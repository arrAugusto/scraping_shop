        ...
        if (textCenterDiv != null) {
            ...
            if (noscript != null) {
                ...
                if (img != null) {
                    ...
                    System.out.println("No se encontró una imagen dentro del noscript.");
                }
            } else {
                System.out.println("No se encontró el elemento noscript dentro del div 'text-center'.");
            }
        } else {
            System.out.println("El div con la clase 'text-center' no se encontró.");
        }
        return "";
    }
    ...
    public String getImageURL(Document doc) {
        ...
        if (flexViewportDiv != null) {
            ...
            if (firstImage != null) {
                ...
                System.out.println("No se encontró la primera imagen dentro del div 'flex-viewport'.");
            }
        } else {
            System.out.println("El div con la clase 'flex-viewport' no se encontró.");
        }
        return "";
    }
}
