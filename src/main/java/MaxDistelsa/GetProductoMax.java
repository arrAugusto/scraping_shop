        ...
        try {
            ...
            if (doc != null) {
                ...
                try {
                    ...
                    System.out.println("No se encontró precio actual: " + e.getMessage());
                ...
                try {
                    ...
                    System.out.println("No se encontró precio antiguo: " + e.getMessage());
    ...
    public String getTitle(Document doc) {
        ...
        if (productInfoMain != null) {
            ...
            if (spanElement != null) {
                ...
                System.out.println("No se encontró el span dentro del div.");
            }
        } else {
            System.out.println("No se encontró el div con la clase 'page-title-wrapper product'.");
        }
        return "";
    }
        ...
        if (productInfoMain != null) {
            ...
            if (contentFree != null) {
                ...
                if (img != null) {
                    ...
                    System.out.println("No se encontró una imagen dentro del div 'content-free'.");
                }
            } else {
                System.out.println("El div con la clase 'content-free' no se encontró.");
            }
        } else {
            System.out.println("El div con la clase 'product-info-main' no se encontró.");
        }
        return "";
    }
    ...
    public String getSKU(Document doc) {
        ...
        if (productInfoMain != null) {
            ...
            if (valueElement != null) {
                ...
                System.out.println("No se encontró el div con la clase 'value' dentro del div.");
            }
        } else {
            System.out.println("No se encontró el div con la clase 'page-title-wrapper product'.");
        }
        ...
        if (productInfoMain != null) {
            ...
            if (valueElement != null) {
                ...
                if (spanElement != null) {
                    ...
                    System.out.println("No se encontró el p dentro del div con la clase 'value'.");
                }
    ...
    public String getPriceValue(Document doc) {
        ...
        if (priceBox != null) {
            ...
            if (priceElement != null) {
                ...
                System.out.println("No se encontró el span con la clase 'price' dentro del div.");
            }
        } else {
            System.out.println("No se encontró el div con la clase 'price-box price-final_price'.");
        }
        return "";
    }
    ...
    public List<Descriptions> getProductAttributes(Document doc) {
        ...
        if (attributeOverview != null) {
            ...
            for (Element listItem : listItems) {
                // Obtener el texto de cada li y añadirlo a la lista de atributos
            ...
            System.out.println("No se encontró el div con la clase 'product attribute overview'.");
        }
    ...
    public List<Especificaciones> getAdditionalAttributes(Document doc) {
        ...
        if (attributesWrapper != null) {
            ...
            if (table != null) {
                ...
                System.out.println("No se encontró la tabla con la clase 'data table additional-attributes'.");
            }
        } else {
            System.out.println("No se encontró el div con la clase 'additional-attributes-wrapper table-wrapper'.");
        }
    ...
    public String getImageURL(Document doc) {
        ...
        if (galleryPlaceholder != null) {
            ...
            if (imgElement != null) {
                ...
                System.out.println("No se encontró la imagen dentro del div con la clase 'gallery-placeholder'.");
            }
        } else {
            System.out.println("No se encontró el div con la clase 'gallery-placeholder'.");
        }
        return "";
    }

    // Método para limpiar el valor y convertirlo a Double
